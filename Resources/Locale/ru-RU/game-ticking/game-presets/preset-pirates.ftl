...
pirates-final-score = The privateers successfully obtained { $score } zorkmids worth
pirates-final-score-2 = of knicknacks, with a total of { $finalPrice } zorkmids.
pirates-list-start = The privateers were:
pirates-most-valuable = The most valuable stolen items were:
pirates-stolen-item-entry = { $entity } ({ $credits } zorkmids)
